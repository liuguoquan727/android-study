...
import com.liuguoquan.module.library.db.User;
...
public class UserDao extends AbstractDao<User, Long> {
  ...
  @Override protected final Long updateKeyAfterInsert(User entity, long rowId) {
    entity.setId(rowId);
    return rowId;
  }
  ...
  @Override public boolean hasKey(User entity) {
