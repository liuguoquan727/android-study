...
public class GridRecyclerViewAdapter
    extends RecyclerView.Adapter<GridRecyclerViewAdapter.ItemHolder>
    implements ItemTouchHelperListener {

  private Context mContext;
  private List<String> mDatas = new ArrayList<>();

  public GridRecyclerViewAdapter(Context context, List<String> datas) {
  ...
  @Override public ItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    View view =
        LayoutInflater.from(mContext).inflate(R.layout.module_ui_item_grid_drag, parent, false);
